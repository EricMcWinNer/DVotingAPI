         ...
         Route::middleware([
             ...
             'oAuthorize'
              ...
              ->group(function () {
                  ...
                  Route::get('/{id}', 'OfficialController@read')
                       ->where('id', '[0-9]+');
     ...
     ->group(function () {
         Route::middleware(['auth.web'])
              ->group(function () {
                  Route::middleware(['oAuthorize'])
                       ->group(function () {
                           Route::get("/index/{perPage?}", "OfficerController@index")
                                ->where("perPage", "[0-9]+");
                           ...
                           Route::post("/{id}", "OfficerController@create")
                                ->where("id", "[0-9]+");

                           Route::delete("/{id}", "OfficerController@delete")
                                ->where("id", "[0-9]+");

                           Route::get("/{id}", "OfficerController@read")
                                ->where('id', '[0-9]+');
                  ...
                  Route::middleware(['ofAuthorize'])
                       ->group(function () {
                           ...
                           Route::get('/voters/{id}/read', 'OfficerVoterController@read')
                                ->where('id', '[0-9]+');

                           Route::post('/voters/{id}/edit', 'OfficerVoterController@edit')
                                ->where('id', '[0-9]+')
     ...
     ->group(function () {
         Route::middleware([
             ...
             'oAuthorize'
              ...
              ->group(function () {
                  Route::get('/{perPage?}', 'RegistrationPinController@index')
                       ->where('perPage', '[0-9]+');
     ...
     ->group(function () {
         ...
         Route::middleware(['auth.web'])
              ->group(function () {
                  ...
                  Route::post('/{partyId}', 'VoteController@vote')
                       ->where('id', '[0-9]+');

                  Route::get('/check', 'VoteController@checkIfVoted');

                  Route::get('/{id}/forward', 'VoteController@forward')
                       ->where('id', '[0-9]+');
